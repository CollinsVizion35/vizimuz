...
const EditProfile = () => {
  ...
  return (
    <>
      <div className={`${isDark ? "bg-black text-white" : "bg-white text-[#0F1419]"}  border-b border-[#2F3336]  flex flex-col min-h-screen overflow-x-hidden`}>
      <div className="bg-inherit border-b border-[#2F3336] p-8 pt-8 pb-8 hidden fixed top-0 lg:flex flex-row items-center justify-between w-screen z-[999999999999]">
        ...
        <div className="bg-inherit border-b border-[#2F3336]  flex flex-row max-w-[1440px] mx-auto my-0 lg:mt-32 mt-20">
