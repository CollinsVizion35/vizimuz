...
const EditProfile = () => {
  ...
  return (
    <>
      <div className="bg-[#000000] border-b border-[#2F3336] text-white flex flex-col min-h-screen overflow-x-hidden">
      <div className="bg-[#000000] border-b border-[#2F3336] p-8 pt-8 pb-8 hidden fixed top-0 lg:flex flex-row items-center justify-between w-screen z-[999999999999]">
        ...
        <div className="bg-[#000000] border-b border-[#2F3336] text-white flex flex-row max-w-[1440px] mx-auto my-0 lg:mt-32 mt-20">
