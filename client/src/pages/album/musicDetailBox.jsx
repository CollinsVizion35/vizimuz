...
function AlbumMusicDetailBox() {
  ...
  return (
    <>
      <>
        <div className="bg-[#1A1E1F] text-white flex flex-col h-max overflow-y-auto overflow-x-hidden">
        <div className="bg-[#1A1E1F] p-8 pt-8 pb-8 hidden fixed top-0 lg:flex flex-row items-center justify-between w-screen z-[999999999999]">
          ...
          <div className="bg-[#1A1E1F] text-white flex flex-col lg:flex-row max-w-[1440px] mx-auto my-0 lg:mt-32 mt-8">
