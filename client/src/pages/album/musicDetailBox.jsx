...
import AlbumMusicDetails from "./musicDetail";
...
function AlbumMusicDetailBox() {
  ...
  return (
    <>
      <>
        <div className="bg-[#040C25] text-white flex flex-col h-max overflow-y-auto overflow-x-hidden">
        <div className="bg-[#040C25] p-8 pt-8 pb-8 hidden fixed top-0 lg:flex flex-row items-center justify-between w-screen z-[999999999999]">
          ...
          <div className="bg-[#040C25] text-white flex flex-col lg:flex-row max-w-[1440px] mx-auto my-0 lg:mt-32 mt-8">
            ...
            <div className="Body w-[90vw] max-w-[1440px] mb-[8em] mx-auto">
              <AlbumMusicDetails />
            </div>
          </div>
        </div>
...
export default AlbumMusicDetailBox;
