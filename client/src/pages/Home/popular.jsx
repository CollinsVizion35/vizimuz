...
const { isDark } = useColorTheme();
  ...
  return (
    <>
      <div className={`${isDark ? "bg-black " : "bg-white text-[#0F1419]"} flex flex-col bg-[#000000] border-b border-[#2F3336] lg:w-[90vw]  w-[95vw] max-w-[1440px]  lg:px-4 float-right text-white`}>
